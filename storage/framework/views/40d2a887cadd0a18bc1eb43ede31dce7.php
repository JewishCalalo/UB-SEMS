    ...
    <div class="container">
        <div class="card">
            ...
            <div class="content">
                ...
                <p>Thanks for your interest in <strong><?php echo e($equipmentName); ?></strong>. We'll send you an email once this item becomes available for reservation.</p>

                <div class="details">
                    <div class="row"><span class="muted">Equipment</span><span><?php echo e($equipmentName); ?></span></div>
                    <?php if($categoryName): ?>
                        <div class="row"><span class="muted">Category</span><span><?php echo e($categoryName); ?></span></div>
                    <?php endif; ?>
                    <?php if($typeName): ?>
                        <div class="row"><span class="muted">Type</span><span><?php echo e($typeName); ?></span></div>
                    <?php endif; ?>
                </div>
            ...
            <div class="footer">© <?php echo e(date('Y')); ?> University of Baguio • SEMS</div>
        </div>
    </div>
</body>
</html>
...
<?php /**PATH C:\UB-SEMS\resources\views\emails\notify-request-received.blade.php ENDPATH**/ ?>