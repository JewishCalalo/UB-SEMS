...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Incident Reports')); ?>
...
<?php endif; ?>
            ...
            <div class="bg-gradient-to-r from-red-50 to-orange-50 border-l-4 border-red-500 p-6 rounded-lg shadow-sm mb-6">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex space-x-3">
                        <a href="<?php echo e(route('instructor.incidents.create')); ?>" 
            ...
            <div class="mb-4 flex justify-end">
                <a href="<?php echo e(route('instructor.dashboard')); ?>" class="inline-flex items-center px-4 py-2 bg-gray-600 text-white text-sm font-medium rounded-md hover:bg-gray-700 focus:ring-2 focus:ring-gray-300 shadow">
            ...
            <div class="bg-white border border-gray-200 rounded-lg shadow-sm">
                                    ...
                                    <?php $__currentLoopData = $incidents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $incident): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm font-semibold text-gray-900"><?php echo e($incident->incident_code); ?></div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm font-medium text-gray-900">#<?php echo e($incident->reservation_id); ?></div>
                                                <div class="text-sm text-gray-500"><?php echo e($incident->reservation->borrow_date->format('M d, Y')); ?> to <?php echo e($incident->reservation->return_date->format('M d, Y')); ?></div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-900">
                                                    <?php
                                                        ...
                                                        foreach ($attachments as $att) {
                                                            if (str_starts_with($att['mime_type'] ?? '', 'image/')) {
                                                                $path = $att['path'] ?? '';
                                                                $thumbUrl = \Illuminate\Support\Str::startsWith($path, ['http://','https://','/'])
                                                                    ? $path
                                                    ...
                                                    <div class="flex items-center space-x-3">
                                                        <span class="font-bold text-gray-900"><?php echo e($equipmentCount); ?></span>
                                                        <span class="text-gray-600">equipment</span>
                                                        <?php if($thumbUrl): ?>
                                                            <button type="button" onclick="showImageModal('<?php echo e($thumbUrl); ?>')" class="ml-3 focus:outline-none">
                                                                <img src="<?php echo e($thumbUrl); ?>" alt="attachment" class="w-10 h-10 object-cover rounded border" />
                                                            </button>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                <?php echo e($incident->created_at->format('M d, Y H:i')); ?>

                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <div class="flex items-center space-x-2">
                                                    <a href="<?php echo e(route('instructor.incidents.show', $incident)); ?>" 
                ...
                <?php else: ?>
                    <div class="text-center py-12">
                        ...
                        <div class="mt-6">
                            <a href="<?php echo e(route('instructor.incidents.create')); ?>" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                                <svg class="-ml-1 mr-2 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z"></path>
                                </svg>
                                Report Incident
...
<?php endif; ?>
<?php /**PATH C:\Users\Bryan\SEMS\SEMSv23\resources\views/instructor/incidents/index.blade.php ENDPATH**/ ?>