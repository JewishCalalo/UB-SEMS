...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Instructor Reports')); ?>
...
<?php endif; ?>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200 mb-8">
                ...
                <div class="p-6">
                    <form method="GET" action="<?php echo e(route('instructor.reports.index')); ?>" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div>
                            ...
                            <select name="type" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500">
                                <option value="reservations" <?php echo e($reportType === 'reservations' ? 'selected' : ''); ?>>Reservations</option>
                                <option value="incidents" <?php echo e($reportType === 'incidents' ? 'selected' : ''); ?>>Incidents</option>
                            </select>
                        </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200 mb-8">
                ...
                <div class="p-6">
                    <form method="POST" action="<?php echo e(route('instructor.reports.export')); ?>" class="flex space-x-4">
                        <?php echo csrf_field(); ?>
            ...
            <?php if($reportType === 'reservations'): ?>
                <?php echo $__env->make('instructor.reports.partials.reservations', ['data' => $data], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php elseif($reportType === 'incidents'): ?>
                <?php echo $__env->make('instructor.reports.partials.incidents', ['data' => $data], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php endif; ?>
        </div>
    </div>
 <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
<?php /**PATH C:\UB-SEMS\resources\views\instructor\reports\index.blade.php ENDPATH**/ ?>