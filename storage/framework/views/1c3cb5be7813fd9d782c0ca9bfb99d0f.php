...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-bold text-2xl text-gray-800 leading-tight">
            <?php echo e(__('Equipment Categories')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form-button','data' => ['variant' => 'danger','size' => 'md','href' => ''.e(route('equipment-categories.create')).'','icon' => 'fas fa-plus']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'danger','size' => 'md','href' => ''.e(route('equipment-categories.create')).'','icon' => 'fas fa-plus']); ?>
                        Add Category
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            ...
            <div class="bg-white border border-gray-200 rounded-xl shadow-lg mb-6 overflow-hidden">
                <nav class="flex" aria-label="Tabs">
                    <a href="<?php echo e(route('equipment-categories.index')); ?>" 
                       class="flex-1 flex items-center justify-center px-8 py-6 text-lg font-semibold <?php echo e(request()->routeIs('equipment-categories.*') ? 'text-white bg-gradient-to-r from-red-600 to-red-700' : 'text-gray-700 bg-gradient-to-r from-gray-50 to-gray-100 hover:from-gray-100 hover:to-gray-200 hover:text-gray-900'); ?> transition-all duration-300 hover:from-red-700 hover:to-red-800 relative group">
                        ...
                        <svg class="w-6 h-6 mr-3 relative z-10 <?php echo e(request()->routeIs('equipment-categories.*') ? 'text-white' : 'text-gray-700'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
                        </svg>
                        <span class="relative z-10 <?php echo e(request()->routeIs('equipment-categories.*') ? 'text-white' : 'text-gray-700'); ?>">Categories</span>
                        <?php if(request()->routeIs('equipment-categories.*')): ?>
                            <div class="absolute bottom-0 left-0 right-0 h-1 bg-white opacity-80"></div>
                        <?php endif; ?>
                    </a>
                    <a href="<?php echo e(route('equipment-types.index')); ?>" 
                       class="flex-1 flex items-center justify-center px-8 py-6 text-lg font-semibold <?php echo e(request()->routeIs('equipment-types.*') ? 'text-white bg-gradient-to-r from-blue-600 to-blue-700' : 'text-gray-700 bg-gradient-to-r from-gray-50 to-gray-100 hover:from-gray-100 hover:to-gray-200 hover:text-gray-900'); ?> transition-all duration-300 hover:from-blue-700 hover:to-blue-800 relative group">
                        ...
                        <svg class="w-6 h-6 mr-3 relative z-10 <?php echo e(request()->routeIs('equipment-types.*') ? 'text-white' : 'text-gray-700'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path>
                        </svg>
                        <span class="relative z-10 <?php echo e(request()->routeIs('equipment-types.*') ? 'text-white' : 'text-gray-700'); ?>">Equipment Types</span>
                        <?php if(request()->routeIs('equipment-types.*')): ?>
                            <div class="absolute bottom-0 left-0 right-0 h-1 bg-white opacity-80"></div>
                        <?php endif; ?>
                    </a>
                </nav>
...
<?php endif; ?>
                                ...
                                <thead class="bg-red-600">
                                    <tr>
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-bold text-white uppercase tracking-wider">
                                            <a href="<?php echo e(route('equipment-categories.index', array_merge(request()->query(), ['sort' => 'created_at', 'direction' => request('direction') === 'asc' && request('sort')==='created_at' ? 'desc' : 'asc']))); ?>" class="inline-flex items-center gap-1 text-white hover:text-gray-200">
                                                Date Added
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4">
                                                <div class="text-sm text-gray-900">
                                                    <?php echo e(Str::limit($category->description, 100) ?: 'No description'); ?>

                                                </div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-900"><?php echo e($category->created_at->format('M d, Y H:i')); ?></div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full bg-blue-100 text-blue-800">
                                                    <?php echo e($category->equipment_count); ?> equipment
                                                </span>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <div class="flex items-center space-x-2">
                                                    <a href="<?php echo e(route('equipment-categories.show', $category)); ?>" 
                                                    ...
                                                    <?php if($category->equipment_count == 0): ?>
                                                        <button type="button" 
                                                                id="delete_category_btn_<?php echo e($category->id); ?>"
                                                                onclick="showDeleteCategoryConfirmation('<?php echo e($category->id); ?>', '<?php echo e($category->name); ?>')"
                    ...
                    <?php else: ?>
                        <div class="text-center py-8">
                            ...
                            <div class="mt-6">
                                <a href="<?php echo e(route('equipment-categories.create')); ?>" 
    ...
    <script>
                ...
                Swal.fire({
                    ...
                    html: `
                        <div class="bg-green-500 text-white p-4 rounded-t-lg -m-6 -mt-6 mb-4" style="margin-left: -24px; margin-right: -24px; margin-top: -24px;">
                            <h2 class="text-xl font-bold text-center">Category <?php echo e(str_contains(session('success'), 'created') ? 'Created' : 'Updated'); ?>!</h2>
                        </div>
        ...
        function deleteEquipmentCategory(categoryId) {
            ...
            ActionHandler.handleAjaxAction(buttonId, `<?php echo e(route('equipment-categories.destroy', ':id')); ?>`.replace(':id', categoryId), {
                method: 'POST',
                data: { 
...
<?php endif; ?>
<?php /**PATH C:\Users\Bryan\SEMS\SEMSv23\resources\views/admin-manager/equipment-categories/index.blade.php ENDPATH**/ ?>