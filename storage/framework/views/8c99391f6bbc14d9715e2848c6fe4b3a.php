<div>
    <nav class="relative z-[300] <?php echo e(request()->routeIs('login') || request()->routeIs('welcome') || request()->routeIs('equipment.*') || request()->routeIs('reservations.track') || request()->routeIs('reservations.guest-confirmation') || request()->routeIs('reservations.confirmation') ? 'bg-white bg-opacity-95 backdrop-blur-sm shadow-lg border-b border-gray-200' : 'bg-white shadow-sm border-b border-gray-100'); ?>" x-data="{ mobileMenuOpen: false }">
        <div class="w-full h-1 bg-red-600"></div>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                <!-- Logo and Title -->
                <div class="flex items-center">
                    <h1 class="text-xl font-extrabold tracking-wide <?php echo e(request()->routeIs('login') ? 'text-gray-900' : 'text-gray-900'); ?>">SEMS</h1>
                    <span class="ml-2 text-sm <?php echo e(request()->routeIs('login') ? 'text-gray-700' : 'text-gray-600'); ?> hidden sm:inline">Sports Equipment Management</span>
                </div>
                
                <!-- Desktop Navigation -->
                <div class="hidden md:flex items-center space-x-4">
                    <!-- Home / Landing Page -->
                    <a href="<?php echo e(route('welcome')); ?>" class="navigation__button <?php echo e((request()->routeIs('welcome') || request()->is('/')) ? 'navigation__button--active' : ''); ?>">
                    ...
                    <a href="<?php echo e(route('reservations.track')); ?>" class="navigation__button <?php echo e(request()->routeIs('reservations.track') ? 'navigation__button--active' : ''); ?>">
                        <svg viewBox="0 0 24 24">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(url('/dashboard')); ?>" class="navigation__button <?php echo e(request()->routeIs('dashboard') ? 'navigation__button--active' : ''); ?>">
                            <svg viewBox="0 0 24 24">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="navigation__button <?php echo e(request()->routeIs('login') ? 'navigation__button--active' : ''); ?>">
        ...
        <div x-show="mobileMenuOpen" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 -translate-y-1" x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100 translate-y-0" x-transition:leave-end="opacity-0 -translate-y-1" class="md:hidden bg-white border-t border-gray-200">
            <div class="px-2 pt-2 pb-3 space-y-1">
                <a href="<?php echo e(route('welcome')); ?>" class="block px-3 py-2 rounded-md text-base font-medium flex items-center space-x-2 <?php echo e(request()->routeIs('welcome') ? 'text-gray-900' : 'text-gray-700 hover:text-gray-900 hover:bg-gray-50'); ?>">
                ...
                <!-- Track Reservation -->
                <a href="<?php echo e(route('reservations.track')); ?>" class="block px-3 py-2 rounded-md text-base font-medium flex items-center space-x-2 <?php echo e(request()->routeIs('reservations.track') ? 'text-gray-900' : 'text-gray-700 hover:text-gray-900 hover:bg-gray-50'); ?>">
                    <svg class="w-5 h-5" viewBox="0 0 24 24">
                        <path d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
                    </svg>
                    <span>Track Reservation</span>
                ...
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(url('/dashboard')); ?>" class="block px-3 py-2 rounded-md text-base font-medium flex items-center space-x-2 <?php echo e(request()->routeIs('dashboard') ? 'text-gray-900' : 'text-gray-700 hover:text-gray-900 hover:bg-gray-50'); ?>">
                        <svg class="w-5 h-5" viewBox="0 0 24 24">
                            <path d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2-2z"></path>
                            <path d="M8 5V3a2 2 0 012-2h4a2 2 0 012 2v2"></path>
                        </svg>
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="block px-3 py-2 rounded-md text-base font-medium flex items-center space-x-2 <?php echo e(request()->routeIs('login') ? 'text-gray-900' : 'text-gray-700 hover:text-gray-900 hover:bg-gray-50'); ?>">
...
<?php /**PATH C:\Users\Bryan\SEMS\SEMSv23\resources\views/components/navigation/welcome-navigation.blade.php ENDPATH**/ ?>