                ...
                popup.querySelector('#edit_save').onclick = async ()=>{
                    ...
                    try{
                        ...
                        await Swal.fire({
                            buttonsStyling:false,
                            html:`
                                <div class="bg-green-600 text-white p-4 -m-6 mb-4 rounded-t-lg"><h2 class="text-xl font-bold text-center">Changes Saved</h2></div>
                                <div class="p-4 text-center text-sm text-gray-700">Your reservation was updated successfully.</div>
                            `,
                            icon: undefined,
                            showConfirmButton:true,
                            customClass:{ popup:'swal-custom-popup' }
...
<?php /**PATH C:\UB-SEMS\resources\views\instructor\reservations\index.blade.php ENDPATH**/ ?>