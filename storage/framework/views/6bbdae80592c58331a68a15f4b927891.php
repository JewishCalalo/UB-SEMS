...
<head>
    ...
    <title>Equipment Reservation Overdue - <?php echo e($reservation->reservation_code); ?></title>
    <style>
        body {
    ...
    <div class="container">
        ...
        <div class="content">
            <div class="alert-box">
                ...
                <p>Your equipment reservation is <strong><?php echo e($daysOverdue); ?> day(s) overdue</strong>. Immediate action is required to return the equipment and avoid further penalties.</p>
            </div>
            ...
            <div class="reservation-details">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value"><?php echo e($reservation->reservation_code); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Name:</span>
                    <span class="detail-value"><?php echo e($reservation->name); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Email:</span>
                    <span class="detail-value"><?php echo e($reservation->email); ?></span>
                </div>
                <?php if($reservation->pickup_date): ?>
                <div class="detail-row">
                    <span class="detail-label">Pickup Date:</span>
                    <span class="detail-value"><?php echo e(\Carbon\Carbon::parse($reservation->pickup_date)->format('F j, Y')); ?></span>
                </div>
                <?php endif; ?>
                <div class="detail-row">
                    <span class="detail-label">Due Date:</span>
                    <span class="detail-value"><?php echo e(\Carbon\Carbon::parse($reservation->return_date)->format('F j, Y')); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Days Overdue:</span>
                    <span class="detail-value" style="color: #dc2626; font-weight: 600;"><?php echo e($daysOverdue); ?> day(s)</span>
                </div>
            </div>
...
<?php /**PATH C:\UB-SEMS\resources\views\emails\reservation-overdue.blade.php ENDPATH**/ ?>