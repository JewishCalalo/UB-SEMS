...
<?php endif; ?>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="<?php echo e(route('instructor.incidents.store')); ?>" class="space-y-6" enctype="multipart/form-data" id="incidentForm">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-6 mb-6 shadow-sm">
                            ...
                            <div>
                                <input type="file" name="attachments[]" id="attachments" multiple
                                       ...
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 bg-white text-sm font-medium transition-all">
                                <p class="text-xs text-gray-500 mt-2">You can upload photos, PDFs, or documents. Maximum 5MB per file. Multiple files allowed.</p>
                                <div id="file_preview" class="mt-4 grid grid-cols-2 md:grid-cols-4 gap-4 hidden">
            ...
            attachmentsInput.addEventListener('change', function() {
                ...
                if (files.length > 0) {
                    ...
                    files.forEach((file, index) => {
                        ...
                        fileDiv.className = 'bg-white border border-gray-200 rounded-lg p-3 text-center';
...
<?php endif; ?>
<?php /**PATH C:\Users\Bryan\SEMS\SEMSv23\resources\views/instructor/incidents/create.blade.php ENDPATH**/ ?>