            ...
            <div class="bg-white border border-gray-200 rounded-xl shadow-lg overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <div class="mb-8">
                        ...
                        <form method="POST" action="<?php echo e(route('profile-user-management.update', $user)); ?>" class="space-y-6" id="updateUserForm">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="border-t border-gray-200 pt-8">
                        ...
                        <form method="POST" action="<?php echo e(route('profile-user-management.password', $user)); ?>" class="space-y-6" id="updatePasswordForm">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>
...
<?php endif; ?>
<?php /**PATH C:\UB-SEMS\resources\views\admin\user-management\edit.blade.php ENDPATH**/ ?>