    ...
    <div class="min-h-screen flex flex-col px-4 sm:px-6 lg:px-8 py-6 sm:py-0 relative">
        ...
        <div class="w-full max-w-sm px-4 sm:px-6 py-6 sm:py-8 bg-white shadow-md rounded-lg border border-gray-100">
            <div class="mb-4 text-center">
                ...
                <p class="text-sm sm:text-base text-gray-600 mt-1">We sent a 6‑digit code to <strong><?php echo e($email); ?></strong>.</p>
            </div>
            ...
            <form method="POST" action="<?php echo e(route('reservations.verify-guest.submit')); ?>" class="space-y-5" id="verifyGuestForm">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
    ...
    <script>
        ...
        function resendGuestCode() {
            ...
            fetch('<?php echo e(route('reservations.verify-guest.resend')); ?>', {
                method: 'POST',
                headers: {
...
<?php /**PATH C:\Users\Bryan\SEMS\SEMSv25\resources\views/user/reservations/verify-guest.blade.php ENDPATH**/ ?>