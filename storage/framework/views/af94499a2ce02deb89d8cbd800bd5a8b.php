    ...
    <div class="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-10 relative">
        ...
        <div class="relative z-10 w-full max-w-xl bg-white/95 backdrop-blur rounded-xl shadow-lg border border-gray-100 p-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-3 justify-center">
                ...
                <a href="<?php echo e(url()->previous()); ?>" class="inline-flex items-center justify-center px-5 py-2.5 rounded-lg border border-gray-300 text-gray-700 bg-white hover:bg-gray-50">
                    Go Back
                </a>
            </div>
        </div>
...
<?php /**PATH C:\UB-SEMS\resources\views\errors\500.blade.php ENDPATH**/ ?>