    ...
    <div class="p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="bg-gray-50 p-4 rounded-lg">
                <div class="text-2xl font-bold text-gray-900"><?php echo e($data['total_equipment_types']); ?></div>
                <div class="text-sm text-gray-600">Equipment Types Used</div>
            </div>
            
            <?php if($data['most_used']): ?>
            <div class="bg-gray-50 p-4 rounded-lg">
                <div class="text-2xl font-bold text-gray-900"><?php echo e($data['most_used']['count']); ?></div>
                <div class="text-sm text-gray-600">Most Used Count</div>
            </div>
            
            <div class="bg-gray-50 p-4 rounded-lg">
                <div class="text-2xl font-bold text-gray-900"><?php echo e($data['most_used']['total_quantity']); ?></div>
        ...
        <?php if($data['equipment_usage']->count() > 0): ?>
        <div class="mb-8">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__currentLoopData = $data['equipment_usage']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900"><?php echo e($usage['equipment']->brand); ?> <?php echo e($usage['equipment']->model); ?></div>
                                <div class="text-sm text-gray-500"><?php echo e($usage['equipment']->description ?? 'No description'); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <?php echo e($usage['equipment']->category->name ?? 'Uncategorized'); ?>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full bg-red-100 text-red-800">
                                    <?php echo e($usage['count']); ?> times
                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                <?php echo e($usage['total_quantity']); ?> units
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <?php
                                ...
                                <div class="w-full bg-gray-200 rounded-full h-2">
                                    <div class="bg-red-600 h-2 rounded-full" style="width: <?php echo e($usageRate); ?>%"></div>
                                </div>
                                <div class="text-xs text-gray-500 mt-1"><?php echo e(number_format($usageRate, 1)); ?>%</div>
                            </td>
                        </tr>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const equipmentData = <?php echo json_encode($data['equipment_usage']->take(10), 15, 512) ?>;
...
<?php endif; ?>
<?php /**PATH C:\UB-SEMS\resources\views\instructor\reports\partials\equipment-usage.blade.php ENDPATH**/ ?>