                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                <?php $__currentLoopData = $incident->attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        ...
                                        // Resolve URL like reservation views
                                    ...
                                    <div class="border border-gray-200 rounded-lg p-4">
                                        <button type="button" class="w-full text-left flex items-center space-x-3 group" <?php if($isImage): ?> onclick="showImageModal('<?php echo e($url); ?>')" <?php else: ?> onclick="window.open('<?php echo e($url); ?>','_blank')" <?php endif; ?>>
                                            <div class="flex-shrink-0">
                                                <?php if($isImage): ?>
                                                    <img src="<?php echo e($url); ?>" alt="<?php echo e($attachment['filename']); ?>" class="w-12 h-12 object-cover rounded shadow-sm group-hover:opacity-90">
                                                <?php else: ?>
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <p class="text-sm font-medium text-gray-900 truncate"><?php echo e($attachment['filename']); ?></p>
                                                <p class="text-xs text-gray-500"><?php echo e(number_format(($attachment['size'] ?? 0) / 1024, 1)); ?> KB</p>
                                            </div>
                                        </button>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Bryan\SEMS\SEMSv23\resources\views/instructor/incidents/show.blade.php ENDPATH**/ ?>