...
<head>
    ...
    <title><?php echo e(config('app.name', 'SEMS')); ?> - Reservation #<?php echo e($reservation->reservation_code); ?></title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    <a href="<?php echo e(route('equipment.index')); ?>" class="text-red-600 hover:text-red-800 px-3 py-2 rounded-md text-sm font-medium">
                        Equipment
                    </a>
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(url('/dashboard')); ?>" class="text-gray-700 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">
                            Dashboard
                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="text-gray-700 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">
                            Staff Login
                        </a>
                    <?php endif; ?>
                </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div class="bg-gray-50 rounded-lg p-4">
                            ...
                            <div class="space-y-2 text-sm text-gray-600">
                                <p><strong>Name:</strong> <?php echo e($reservation->user ? $reservation->user->name : $reservation->name); ?></p>
                                <p><strong>Email:</strong> <?php echo e($reservation->user ? $reservation->user->email : $reservation->email); ?></p>
                        ...
                        <div class="space-y-3">
                            <?php $__currentLoopData = $reservation->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex justify-between items-center p-4 bg-gray-50 rounded-lg border">
                                    <div class="flex items-center space-x-4">
                                        <img src="<?php echo e($item->equipment->primary_image ? Storage::url($item->equipment->primary_image->image_path) : asset('images/placeholder.jpg')); ?>" 
                                             alt="<?php echo e($item->equipment->name); ?>" 
                                             class="w-16 h-16 object-cover rounded">
                                        <div>
                                            <p class="font-medium text-gray-900"><?php echo e($item->equipment->name); ?></p>
                                            <p class="text-sm text-gray-600"><?php echo e($item->equipment->category->name); ?></p>
                                            <p class="text-sm text-gray-500"><?php echo e($item->equipment->brand ?? 'N/A'); ?> <?php echo e($item->equipment->model ?? ''); ?></p>
                                        </div>
                                    </div>
                                    <div class="text-right">
                                        <p class="font-medium text-gray-900">Qty: <?php echo e($item->quantity_requested); ?></p>
                                        <?php if($item->quantity_approved && $item->quantity_approved != $item->quantity_requested): ?>
                                            <p class="text-sm text-orange-600 font-medium">Approved: <?php echo e($item->quantity_approved); ?></p>
                                        <?php endif; ?>
                                        <p class="text-sm text-gray-600">
                                            <?php if($item->equipment->quantity_available >= $item->quantity_requested): ?>
                    ...
                    <div class="flex justify-between items-center pt-6 border-t">
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <?php if(Auth::user()->hasAnyRole(['manager', 'admin']) || Auth::id() === $reservation->user_id): ?>
                                <div class="flex space-x-3">
                                    <?php if(Auth::user()->hasAnyRole(['manager', 'admin'])): ?>
                                    ...
                                    <?php if(Auth::id() === $reservation->user_id && $reservation->status === 'pending'): ?>
                                        <button type="button" 
...
<?php /**PATH C:\UB-SEMS\resources\views\user\reservations\show.blade.php ENDPATH**/ ?>