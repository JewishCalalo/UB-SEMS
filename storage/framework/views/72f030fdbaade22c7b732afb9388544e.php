                ...
                <div class="bg-gradient-to-r from-red-500 to-red-600 px-8 py-6">
                    <div class="flex justify-between items-start">
                        <div class="text-white">
                            <h1 class="text-3xl font-bold mb-2 text-white"><?php echo e($equipment->display_name); ?></h1>
                            <div class="flex items-center space-x-4 text-white">
                                ...
                                <span class="flex items-center">
                                    ...
                                    <?php echo e($maintenanceRecords->count()); ?> Maintenance Records
                                </span>
                            </div>
                        </div>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <?php $__currentLoopData = $maintenanceRecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <?php if($instanceCount > 0): ?>
                                            <?php $__currentLoopData = $affectedInstances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $instance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr class="hover:bg-gray-50 transition-colors duration-150" data-record-id="<?php echo e($record->id); ?>">
                                                    <?php if($index === 0): ?>
                                                        <!-- Date column (shared across instances) -->
                                                        <td class="px-6 py-4 whitespace-nowrap" rowspan="<?php echo e($instanceCount); ?>">
                                                            <div class="text-sm text-gray-900 font-medium"><?php echo e($record->maintenance_date->format('M d, Y')); ?></div>
                                                            <div class="text-sm text-gray-500"><?php echo e($record->maintenance_date->format('g:i A')); ?></div>
                                                        </td>
                                                        ...
                                                        <td class="px-6 py-4 whitespace-nowrap" rowspan="<?php echo e($instanceCount); ?>">
                                                            ...
                                                            ?>
                                                            <span class="inline-flex px-3 py-1.5 text-xs font-semibold rounded-full <?php echo e($typeColor); ?> shadow-sm">
                                                                <?php echo e($displayType); ?>

                                                            </span>
                                                        </td>
                                                        <!-- Description column (shared across instances) -->
                                                        <td class="px-6 py-4" rowspan="<?php echo e($instanceCount); ?>">
                                                            <?php
                                                            ...
                                                            <div class="text-sm text-gray-900">
                                                                <?php echo e($descToShow ? Str::limit($descToShow, 60) : 'No description provided'); ?>

                                                            </div>
                                                            <?php if($record->notes): ?>
                                                                <div class="text-sm text-gray-500 mt-1">
                                                                    <?php echo e(Str::limit($record->notes, 40)); ?>
                                                        ...
                                                        <td class="px-6 py-4 whitespace-nowrap" rowspan="<?php echo e($instanceCount); ?>">
                                                            <div class="text-sm text-gray-900"><?php echo e($record->performed_by ?: 'Not specified'); ?></div>
                                                        </td>
                                                    <?php endif; ?>
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        <div class="text-sm font-medium text-gray-900">
                                                            <?php echo e($instance['instance_code'] ?? 'N/A'); ?>
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        ...
                                                        ?>
                                                        <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full <?php echo e($oldConditionColor); ?>">
                                                            <?php echo e(ucfirst(str_replace('_', ' ', $instance['old_condition'] ?? 'Not tracked'))); ?>
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        ...
                                                        ?>
                                                        <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full <?php echo e($newConditionColor); ?>">
                                                            <?php echo e(ucfirst(str_replace('_', ' ', $instance['new_condition'] ?? 'Not tracked'))); ?>
                                        ...
                                        <?php else: ?>
                                            ...
                                            <tr class="hover:bg-gray-50 transition-colors duration-150" data-record-id="<?php echo e($record->id); ?>">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    ...
                                                    ?>
                                                    <span class="inline-flex px-3 py-1.5 text-xs font-semibold rounded-full <?php echo e($typeColor); ?> shadow-sm">
                                                        <?php echo e(ucfirst(str_replace('_', ' ', $record->maintenance_type))); ?>

                                                    </span>
                                                </td>
                                                <td class="px-6 py-4">
                                                    <div class="text-sm text-gray-900">
                                                        <?php echo e($record->description ? Str::limit($record->description, 60) : 'No description provided'); ?>
...
<?php endif; ?>
<?php /**PATH C:\UB-SEMS\resources\views\admin-manager\maintenance-management\show.blade.php ENDPATH**/ ?>