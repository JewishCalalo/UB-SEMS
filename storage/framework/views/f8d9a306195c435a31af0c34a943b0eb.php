...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Walk-in Equipment Reservation (University Staff/Employees)')); ?>
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200">
                <div class="p-8">
                    ...
                    <form method="POST" action="<?php echo e(route('reservation-management.store')); ?>" class="space-y-6" id="reservationForm" novalidate>
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <select name="department" id="department" required
                                        ...
                                        <option value="Human Resources" <?php echo e(old('department')==='Human Resources' ? 'selected' : ''); ?>>Human Resources</option>
                                        <option value="Finance" <?php echo e(old('department')==='Finance' ? 'selected' : ''); ?>>Finance</option>
                                        <option value="Registrar" <?php echo e(old('department')==='Registrar' ? 'selected' : ''); ?>>Registrar</option>
                                        <option value="Facilities" <?php echo e(old('department')==='Facilities' ? 'selected' : ''); ?>>Facilities</option>
                                        <option value="IT" <?php echo e(old('department')==='IT' ? 'selected' : ''); ?>>IT</option>
                                        <option value="PE Department" <?php echo e(old('department')==='PE Department' ? 'selected' : ''); ?>>PE Department</option>
                                        <option value="Other" <?php echo e(old('department')==='Other' ? 'selected' : ''); ?>>Other</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div id="other_department_wrapper" class="<?php echo e(old('department')==='Other' ? '' : 'hidden'); ?>">
                                    ...
                                    <input type="text" name="other_department" id="other_department"
                                           value="<?php echo e(old('other_department')); ?>"
                                           class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500"
                                           placeholder="Enter department name">
                                    <?php $__errorArgs = ['other_department'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="date" name="borrow_date" id="borrow_date" required
                                           value="<?php echo e(old('borrow_date')); ?>"
                                ...
                                <div>
                                    ...
                                    <div class="mt-1 flex items-center gap-2">
                                        <select id="borrow_hour" class="px-2 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500" style="width: 4.5rem;">
                                            <?php for($h=1;$h<=12;$h++): ?>
                                                <option value="<?php echo e(str_pad($h,2,'0',STR_PAD_LEFT)); ?>"><?php echo e($h); ?></option>
                                            <?php endfor; ?>
                                        </select>
                                        <select id="borrow_minute" class="px-2 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500" style="width: 4.5rem;">
                                            <?php $__currentLoopData = ["00","05","10","15","20","25","30","35","40","45","50","55"]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <input type="hidden" name="borrow_time" id="borrow_time" value="<?php echo e(old('borrow_time')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="hidden" name="return_time" id="return_time" value="<?php echo e(old('return_time')); ?>">
                        ...
                        <div class="bg-gray-50 rounded-lg p-6 mb-6">
                            ...
                            <div>
                                ...
                                <select name="reason" id="reason" required
                                    ...
                                    <option value="PE Class" <?php echo e(old('reason') == 'PE Class' ? 'selected' : ''); ?>>PE Class</option>
                                    <option value="Sports Event" <?php echo e(old('reason') == 'Sports Event' ? 'selected' : ''); ?>>Sports Event</option>
                                    <option value="Training Session" <?php echo e(old('reason') == 'Training Session' ? 'selected' : ''); ?>>Training Session</option>
                                    <option value="Research/Study" <?php echo e(old('reason') == 'Research/Study' ? 'selected' : ''); ?>>Research/Study</option>
                                    <option value="Other" <?php echo e(old('reason') == 'Other' ? 'selected' : ''); ?>>Other (Specify)</option>
                                </select>
                                    ...
                                    <table class="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200" id="equipment-table-body">
                                                ...
                                                <tr class="equipment-row hover:bg-gray-50" 
                                                            data-category="<?php echo e($eq->category_id); ?>"
                                                            data-equipment-type="<?php echo e($eq->equipment_type_id); ?>"
                                                            data-brand="<?php echo e(strtolower($eq->brand)); ?>"
                                                            data-model="<?php echo e(strtolower($eq->model)); ?>"
                                                            data-category-name="<?php echo e(strtolower($eq->category->name)); ?>"
                                                            data-type-name="<?php echo e(strtolower($eq->equipmentType->name ?? '')); ?>">
                                                    <td class="px-4 py-3 whitespace-nowrap">
                                                        <div class="text-sm font-medium text-gray-900"><?php echo e($eq->name); ?></div>
                                                        <div class="text-sm text-gray-500"><?php echo e($eq->brand ?: 'No brand'); ?> <?php echo e($eq->model ?: ''); ?></div>
                                                    </td>
                                                    <td class="px-4 py-3 whitespace-nowrap">
                                                        <div class="space-y-1">
                                                            <span class="inline-flex px-2 py-1 text-xs font-medium rounded-full bg-blue-100 text-blue-800">
                                                                <?php echo e($eq->category->name); ?>

                                                            </span>
                                                            <?php if($eq->equipmentType): ?>
                                                                <br>
                                                                <span class="inline-flex px-2 py-1 text-xs font-medium rounded-full bg-purple-100 text-purple-800">
                                                                    <?php echo e($eq->equipmentType->name); ?>
                                                    ...
                                                    <td class="px-4 py-3 whitespace-nowrap">
                                                        <span class="text-sm text-gray-900">
                                                            <span class="block"><?php echo e($eq->quantity_available); ?></span>
                                                            <span class="text-xs text-gray-500 date-specific-availability" style="display: none;">
                                                                for selected dates: <span class="bookable-count" data-equipment-id="<?php echo e($eq->id); ?>">-</span>
                                                            </span>
                                                        </span>
                                                    </td>
                                                    <td class="px-4 py-3 whitespace-nowrap">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form-button','data' => ['type' => 'button','variant' => 'primary','size' => 'sm','icon' => 'fas fa-plus','dataEquipmentId' => ''.e($eq->id).'','dataEquipmentName' => ''.e($eq->name).'','dataEquipmentBrand' => ''.e($eq->brand).'','dataEquipmentModel' => ''.e($eq->model).'','dataEquipmentCategory' => ''.e($eq->category->name).'','dataEquipmentType' => ''.e($eq->equipmentType->name ?? 'N/A').'','dataEquipmentAvailable' => ''.e($eq->quantity_available).'','onclick' => 'showQuantityModal(this)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','variant' => 'primary','size' => 'sm','icon' => 'fas fa-plus','data-equipment-id' => ''.e($eq->id).'','data-equipment-name' => ''.e($eq->name).'','data-equipment-brand' => ''.e($eq->brand).'','data-equipment-model' => ''.e($eq->model).'','data-equipment-category' => ''.e($eq->category->name).'','data-equipment-type' => ''.e($eq->equipmentType->name ?? 'N/A').'','data-equipment-available' => ''.e($eq->quantity_available).'','onclick' => 'showQuantityModal(this)']); ?>
                                                            Add
                        ...
                        <div class="bg-gray-50 rounded-lg p-6 mb-6">
                            ...
                            <div>
                                ...
                                <textarea name="remarks" id="remarks" rows="2"
                                          class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500"
                                          placeholder="Any special notes or instructions..."><?php echo e(old('remarks')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="flex justify-end space-x-4 pt-6 border-t border-gray-200">
                            <?php if (isset($component)) { $__componentOriginalbb660c7d3380b22758129b879204cbaa = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbb660c7d3380b22758129b879204cbaa = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form-button','data' => ['variant' => 'secondary','size' => 'md','href' => ''.e(route('reservation-management.index')).'','icon' => 'fas fa-times']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('form-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'secondary','size' => 'md','href' => ''.e(route('reservation-management.index')).'','icon' => 'fas fa-times']); ?>
                                Cancel
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalbb660c7d3380b22758129b879204cbaa)): ?>
...
<?php endif; ?>
                            <?php if (isset($component)) { $__componentOriginalbb660c7d3380b22758129b879204cbaa = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbb660c7d3380b22758129b879204cbaa = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form-button','data' => ['type' => 'submit','variant' => 'primary','size' => 'md','icon' => 'fas fa-check']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('form-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','variant' => 'primary','size' => 'md','icon' => 'fas fa-check']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['name' => 'quantity-modal','maxWidth' => 'lg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'quantity-modal','maxWidth' => 'lg']); ?>
        <div class="p-6">
            ...
            <div class="flex justify-end space-x-3">
                <?php if (isset($component)) { $__componentOriginalbb660c7d3380b22758129b879204cbaa = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbb660c7d3380b22758129b879204cbaa = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form-button','data' => ['type' => 'button','variant' => 'secondary','size' => 'md','onclick' => 'closeQuantityModal()','icon' => 'fas fa-times']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('form-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','variant' => 'secondary','size' => 'md','onclick' => 'closeQuantityModal()','icon' => 'fas fa-times']); ?>
                    Cancel
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalbb660c7d3380b22758129b879204cbaa)): ?>
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginalbb660c7d3380b22758129b879204cbaa = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbb660c7d3380b22758129b879204cbaa = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form-button','data' => ['type' => 'button','variant' => 'primary','size' => 'md','onclick' => 'addEquipmentFromModal()','icon' => 'fas fa-plus']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('form-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','variant' => 'primary','size' => 'md','onclick' => 'addEquipmentFromModal()','icon' => 'fas fa-plus']); ?>
                    Add to Reservation
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalbb660c7d3380b22758129b879204cbaa)): ?>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginal9f64f32e90b9102968f2bc548315018c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9f64f32e90b9102968f2bc548315018c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['name' => 'notification-modal','maxWidth' => 'md']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'notification-modal','maxWidth' => 'md']); ?>
        <div class="p-6">
            ...
            <div class="text-center">
                ...
                <?php if (isset($component)) { $__componentOriginalbb660c7d3380b22758129b879204cbaa = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbb660c7d3380b22758129b879204cbaa = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form-button','data' => ['type' => 'button','variant' => 'primary','size' => 'md','onclick' => 'closeNotificationModal()','icon' => 'fas fa-check']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('form-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','variant' => 'primary','size' => 'md','onclick' => 'closeNotificationModal()','icon' => 'fas fa-check']); ?>
                    OK
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalbb660c7d3380b22758129b879204cbaa)): ?>
...
<?php endif; ?>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const allTypes = <?php echo json_encode($equipmentTypes->map(fn($t) => ['id'=>$t->id, 'name'=>$t->name, 'category_id'=>$t->category_id])) ?>;
...
<?php endif; ?>
<?php /**PATH C:\Users\Bryan\SEMS\SEMSv23\resources\views/admin-manager/reservation-management/create.blade.php ENDPATH**/ ?>