...
<head>
    ...
    <title><?php echo e(config('app.name', 'SEMS')); ?> - Forgot Password</title>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="text-center">
                    <a href="<?php echo e(route('login')); ?>" class="text-sm text-red-600 hover:text-red-500 transition-all duration-150 ease-in-out font-medium hover:underline">
                        ← Back to Login
                    </a>
                </div>
            </form>
...
<?php /**PATH C:\UB-SEMS\resources\views\auth\forgot-password.blade.php ENDPATH**/ ?>