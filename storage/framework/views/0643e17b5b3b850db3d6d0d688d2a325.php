...
<head>
    ...
    <title><?php echo e(config('app.name', 'SEMS')); ?> - <?php echo e($equipment->display_name); ?></title>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div>
                            <div class="mb-4">
                                <?php if($equipment->images->count() > 0): ?>
                                    <img src="<?php echo e($equipment->images->first()->url); ?>" 
                                         alt="<?php echo e($equipment->display_name); ?>" class="w-full h-96 object-cover rounded-lg">
                                <?php else: ?>
                            ...
                            <?php if($equipment->images->count() > 1): ?>
                                <div class="grid grid-cols-4 gap-2">
                                    <?php $__currentLoopData = $equipment->images->skip(1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <img src="<?php echo e($image->url); ?>" 
                                             alt="<?php echo e($equipment->display_name); ?>" class="w-full h-20 object-cover rounded cursor-pointer hover:opacity-75 transition-opacity"
                        ...
                        <!-- Details -->
                        <div>
                            <h1 class="text-3xl font-bold mb-4"><?php echo e($equipment->display_name); ?></h1>
                            
                            <div class="space-y-3">
                                <p><strong>Category:</strong> <?php echo e($equipment->category->name); ?></p>
                                <?php if($equipment->equipmentType): ?>
                                    <p><strong>Equipment Type:</strong> <?php echo e($equipment->equipmentType->name); ?></p>
                                <?php endif; ?>
                                <p><strong>Brand:</strong> <?php echo e($equipment->brand ?? 'N/A'); ?></p>
                                <p><strong>Model:</strong> <?php echo e($equipment->model ?? 'N/A'); ?></p>
                                <p><strong>Location:</strong> <?php echo e($equipment->location ?? 'N/A'); ?></p>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span class="ml-2 px-2 py-1 rounded text-sm 
                                        ...
                                        <?php echo e(ucfirst($equipment->condition)); ?>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span class="ml-2 px-2 py-1 rounded text-sm 
                                        <?php if($equipment->quantity_available > 0): ?> bg-green-100 text-green-800
                                        <?php else: ?> bg-red-100 text-red-800 <?php endif; ?>">
                                        <?php echo e($equipment->quantity_available); ?> / <?php echo e($equipment->quantity_total); ?> available
                                    </span>
                                </div>

                                
                                <p><strong>Purchase Date:</strong> <?php echo e($equipment->purchase_date ? $equipment->purchase_date->format('M d, Y') : 'N/A'); ?></p>
                                
                                <div class="mt-4">
                                    <h3 class="font-semibold mb-2">Description</h3>
                                    <p class="text-gray-600"><?php echo e($equipment->description ?? 'No description available.'); ?></p>
                                </div>
                                     ...
                                     <?php if($equipment->quantity_available > 0): ?>
                                         <div class="flex items-center space-x-2">
                                             <input type="number" 
                                                    min="1" 
                                                    max="<?php echo e($equipment->quantity_available); ?>" 
                                                    value="1" 
                                                    class="w-20 px-3 py-2 border rounded quantity-input"
                                                    id="equipment-quantity">
                                             <button onclick="addToCart(<?php echo e($equipment->id); ?>, '<?php echo e($equipment->display_name); ?>', <?php echo e($equipment->quantity_available); ?>)" 
                                     ...
                                     <?php else: ?>
                                         <button onclick="addToWishlist(<?php echo e($equipment->id); ?>, '<?php echo e($equipment->display_name); ?>')" 
    ...
    <div id="reservationModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50 flex items-center justify-center p-4">
        <div class="relative mx-auto p-6 border w-full max-w-2xl shadow-2xl rounded-xl bg-white">
            <div class="mt-3">
                ...
                <form id="reservationForm" method="POST" action="<?php echo e(route('reservations.store')); ?>" class="space-y-4">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\UB-SEMS\resources\views\user\equipment\show.blade.php ENDPATH**/ ?>