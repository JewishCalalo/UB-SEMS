...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-bold text-2xl text-gray-800 leading-tight">
            <?php echo e(__('Edit Equipment Type')); ?>
            ...
            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border-l-4 border-blue-500 p-6 rounded-lg shadow-sm mb-6">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-blue-700 font-medium">Update equipment type information: <?php echo e($equipmentType->name); ?></p>
                    </div>
...
<?php endif; ?>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="<?php echo e(route('equipment-types.update', $equipmentType)); ?>" class="space-y-6" id="editTypeForm" novalidate>
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="bg-blue-50/60 p-6 rounded-xl border border-blue-100">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="hidden" name="category_id" value="<?php echo e($equipmentType->category_id); ?>">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="name" id="name" value="<?php echo e(old('name', $equipmentType->name)); ?>" required
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mt-6">
                                ...
                                <textarea name="description" id="description" rows="4"
                                          class="w-full px-4 py-3 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-base font-medium"
                                          placeholder="Describe what this equipment type is used for..."><?php echo e(old('description', $equipmentType->description)); ?></textarea>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','variant' => 'primary','icon' => 'fas fa-save']); ?>Update Equipment Type <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalbb660c7d3380b22758129b879204cbaa)): ?>
<?php $attributes = $__attributesOriginalbb660c7d3380b22758129b879204cbaa; ?>
<?php unset($__attributesOriginalbb660c7d3380b22758129b879204cbaa); ?>
...
<?php endif; ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const originalName = '<?php echo e($equipmentType->name); ?>';
            const categoryId = '<?php echo e($equipmentType->category_id); ?>';
...
<?php endif; ?>
<?php /**PATH C:\UB-SEMS\resources\views\admin-manager\equipment-types\edit.blade.php ENDPATH**/ ?>