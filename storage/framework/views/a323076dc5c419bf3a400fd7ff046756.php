                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <?php if($reservation->status === 'cancelled' && $reservation->remarks): ?>
                                <div class="bg-red-50 border border-red-200 rounded-lg p-4">
                                    <h4 class="text-sm font-semibold text-red-800 mb-2">Cancellation Remarks</h4>
                                    <p class="text-sm text-red-700"><?php echo e($reservation->remarks); ?></p>
                                </div>
                            <?php elseif($reservation->status === 'denied' && $reservation->remarks): ?>
                                <div class="bg-orange-50 border border-orange-200 rounded-lg p-4">
                                    <h4 class="text-sm font-semibold text-orange-800 mb-2">Decline Remarks</h4>
                                    <p class="text-sm text-orange-700"><?php echo e($reservation->remarks); ?></p>
                                </div>
                            <?php elseif($reservation->remarks): ?>
...
<?php /**PATH C:\Users\Bryan\SEMS\SEMSv25\resources\views/admin-manager/reservation-management/show.blade.php ENDPATH**/ ?>