...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form-button','data' => ['variant' => 'primary','size' => 'md','href' => ''.e(route('equipment-types.create')).'','icon' => 'fas fa-plus']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'primary','size' => 'md','href' => ''.e(route('equipment-types.create')).'','icon' => 'fas fa-plus']); ?>
                        Add Equipment Type
                     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <?php $__currentLoopData = $equipmentTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $equipmentType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm font-medium text-gray-900"><?php echo e($equipmentType->name); ?></div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <td class="px-6 py-4">
                                                <div class="text-sm text-gray-900">
                                                    <?php echo e(Str::limit($equipmentType->description, 100) ?: 'No description'); ?>

                                                </div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-900"><?php echo e($equipmentType->equipment->count()); ?></div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <div class="flex items-center space-x-2">
                                                    <a href="<?php echo e(route('equipment-types.show', $equipmentType)); ?>" 
                                                    ...
                                                    <a href="<?php echo e(route('equipment-types.edit', $equipmentType)); ?>" 
                                                    ...
                                                    <?php if($equipmentType->equipment->count() == 0): ?>
                                                                                                                <button type="button" 
                                                                id="delete_type_btn_<?php echo e($equipmentType->id); ?>"
                                                                onclick="showDeleteTypeConfirmation('<?php echo e($equipmentType->id); ?>', '<?php echo e($equipmentType->name); ?>')"
                        ...
                        <!-- Pagination -->
                        <div class="mt-6">
                            <?php echo e($equipmentTypes->links()); ?>
                    ...
                    <?php else: ?>
                        <div class="text-center py-12">
                            ...
                            <div class="mt-6">
                                <a href="<?php echo e(route('equipment-types.create')); ?>" 
    ...
    <script>
                ...
                Swal.fire({
                    ...
                    html: `
                        <div class="bg-green-500 text-white p-4 rounded-t-lg -m-6 -mt-6 mb-4" style="margin-left: -24px; margin-right: -24px; margin-top: -24px;">
                            <h2 class="text-xl font-bold text-center">Equipment Type <?php echo e(str_contains(session('success'), 'created') ? 'Created' : 'Updated'); ?>!</h2>
                        </div>
        ...
        function deleteEquipmentType(typeId) {
            ...
            ActionHandler.handleAjaxAction(buttonId, `<?php echo e(route('equipment-types.destroy', ':id')); ?>`.replace(':id', typeId), {
                method: 'POST',
                data: { 
...
<?php endif; ?>
<?php /**PATH C:\Users\Bryan\SEMS\SEMSv23\resources\views/admin-manager/equipment-types/index.blade.php ENDPATH**/ ?>