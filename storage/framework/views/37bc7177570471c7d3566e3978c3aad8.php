    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="<?php echo e(route('equipment.store')); ?>" enctype="multipart/form-data" class="space-y-6">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="quantity_total" id="quantity_total" value="<?php echo e(old('quantity_total', 1)); ?>" min="1" required
...
<?php endif; ?>
<?php /**PATH C:\UB-SEMS\resources\views\user\equipment\create.blade.php ENDPATH**/ ?>