<x-app-layout>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="date" name="borrow_date" id="borrow_date" required
                                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 bg-white text-sm font-medium transition-all @error('borrow_date') border-red-500 @enderror"
                                           min="{{ date('Y-m-d') }}" value="{{ old('borrow_date') }}">
                                    @error('borrow_date')
                                ...
                                <div>
                                    ...
                                    <input type="date" name="return_date" id="return_date" required
                                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 bg-white text-sm font-medium transition-all @error('return_date') border-red-500 @enderror"
                                           min="{{ date('Y-m-d') }}" value="{{ old('return_date') }}">
                                    @error('return_date')
                                        <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="space-y-3">
                                        ...
                                        <div class="flex items-center space-x-3">
                                            <div class="flex-1">
                                                <select id="borrow_hour" name="borrow_hour" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500">
                                                    ...
                                                    @for($i = 1; $i <= 12; $i++)
                                                        <option value="{{ sprintf('%02d', $i) }}" {{ old('borrow_hour') == sprintf('%02d', $i) ? 'selected' : '' }}>{{ $i }}</option>
                                                    @endfor
                                                </select>
                                            </div>
                                            ...
                                            <div class="flex-1">
                                                <select id="borrow_minute" name="borrow_minute" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500">
                                                    ...
                                                    @for($i = 0; $i < 60; $i += 15)
                                                        <option value="{{ sprintf('%02d', $i) }}" {{ old('borrow_minute') == sprintf('%02d', $i) ? 'selected' : '' }}>{{ sprintf('%02d', $i) }}</option>
                                                    @endfor
                                                </select>
                                            </div>
                                            <div class="flex-1">
                                                <select id="borrow_period" name="borrow_period" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500">
                                                    ...
                                                    <option value="AM" {{ old('borrow_period') == 'AM' ? 'selected' : '' }}>AM</option>
                                                    <option value="PM" {{ old('borrow_period') == 'PM' ? 'selected' : '' }}>PM</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <input type="hidden" id="borrow_time" name="borrow_time" value="{{ old('borrow_time') }}">
                                    </div>
                                    @error('borrow_time')
                                        <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                                    @enderror
                                        ...
                                        <div class="flex items-center space-x-3">
                                            <div class="flex-1">
                                                <select id="return_hour" name="return_hour" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500">
                                                    <option value="">Hour</option>
                                                    @for($i = 1; $i <= 12; $i++)
                                                        <option value="{{ sprintf('%02d', $i) }}" {{ old('return_hour') == sprintf('%02d', $i) ? 'selected' : '' }}>{{ $i }}</option>
                                                    @endfor
                                                </select>
                                            </div>
                                            <span class="text-gray-500 font-bold text-lg">:</span>
                                            <div class="flex-1">
                                                <select id="return_minute" name="return_minute" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500">
                                                    <option value="">Min</option>
                                                    @for($i = 0; $i < 60; $i += 15)
                                                        <option value="{{ sprintf('%02d', $i) }}" {{ old('return_minute') == sprintf('%02d', $i) ? 'selected' : '' }}>{{ sprintf('%02d', $i) }}</option>
                                                    @endfor
                                                </select>
                                            </div>
                                            <div class="flex-1">
                                                <select id="return_period" name="return_period" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500">
                                                    <option value="">AM/PM</option>
                                                    <option value="AM" {{ old('return_period') == 'AM' ? 'selected' : '' }}>AM</option>
                                                    <option value="PM" {{ old('return_period') == 'PM' ? 'selected' : '' }}>PM</option>
                                                </select>
                                            </div>
                                        </div>
                        ...
                        <div class="bg-white border border-gray-200 rounded-lg mb-8 shadow-sm">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <div class="relative">
                                        <select id="category-filter" class="appearance-none pl-3 pr-10 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-red-500 focus:border-red-500 bg-white w-full" style="background-image:none;">
                                            ...
                                            @foreach($equipment->pluck('category.name')->unique() as $category)
                            ...
                            <div class="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5" id="equipment-grid">
                                @foreach($equipment as $item)
                                    <div class="equipment-card border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow {{ $item->quantity_available <= 0 ? 'bg-gray-50' : 'bg-white' }}" 
                                        ...
                                        <div class="flex items-start space-x-3">
                                            <input type="checkbox" 
                                                   ...
                                                   value="{{ $item->id }}" @if($item->quantity_available <= 0) disabled @endif
                                            ...
                                            <div class="flex-shrink-0">
                                                ...
                                                @endphp
                                                @if($imageUrl)
                                                    <img src="{{ $imageUrl }}" alt="{{ $item->display_name }}" class="w-16 h-16 object-cover rounded-lg border border-gray-200" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                            ...
                                            <div class="flex-1">
                                                <div class="flex items-start justify-between">
                                                    ...
                                                    <span class="ml-2 inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-medium {{ $item->quantity_available>0 ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700' }}">
                                                        {{ $item->quantity_available>0 ? 'Available' : 'Unavailable' }}
                                                    </span>
                                                </div>
                                                <p class="text-xs text-gray-500 mt-1">{{ $item->category->name }}</p>
                                                <p class="text-xs text-gray-500">Available: <span class="font-medium {{ $item->quantity_available>0 ? 'text-green-600' : 'text-red-600' }}">{{ $item->quantity_available }}</span></p>
                                                
                                                @if($item->description)
                                                    <p class="text-xs text-gray-600 mt-2">{{ Str::limit($item->description, 60) }}</p>
                                                @endif
                                                ...
                                                <div class="mt-3 quantity-controls hidden">
                                                    ...
                                                    <div class="flex items-center space-x-2">
                                                        ...
                                                        <input type="number" 
                                                               ...
                                                               @if($item->quantity_available <= 0) disabled @endif
                                                               min="{{ $item->quantity_available > 0 ? 1 : 0 }}" 
                                                               max="{{ $item->quantity_available }}" 
                                                               value="{{ $item->quantity_available > 0 ? 1 : 0 }}" 
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <select name="reason_type" id="reason_type" required
                                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 bg-white text-sm font-medium transition-all @error('reason_type') border-red-500 @enderror">
                                        <option value="">Select a purpose</option>
                                        <option value="PE Class" {{ old('reason_type') == 'PE Class' ? 'selected' : '' }}>PE Class</option>
                                        <option value="Sports Training" {{ old('reason_type') == 'Sports Training' ? 'selected' : '' }}>Sports Training</option>
                                        <option value="Tournament" {{ old('reason_type') == 'Tournament' ? 'selected' : '' }}>Tournament</option>
                                        <option value="Practice Session" {{ old('reason_type') == 'Practice Session' ? 'selected' : '' }}>Practice Session</option>
                                        <option value="Intramural Sports" {{ old('reason_type') == 'Intramural Sports' ? 'selected' : '' }}>Intramural Sports</option>
                                        <option value="Special Event" {{ old('reason_type') == 'Special Event' ? 'selected' : '' }}>Special Event</option>
                                        <option value="Research/Study" {{ old('reason_type') == 'Research/Study' ? 'selected' : '' }}>Research/Study</option>
                                        <option value="Other" {{ old('reason_type') == 'Other' ? 'selected' : '' }}>Other (Specify)</option>
                                    </select>
                                    @error('reason_type')
                                        <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                                    @enderror
                                ...
                                <div id="custom_reason_div" class="hidden">
                                    ...
                                    <textarea name="custom_reason" id="custom_reason" rows="3"
                                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 bg-white text-sm font-medium transition-all @error('custom_reason') border-red-500 @enderror"
                                ...
                                <div>
                                    ...
                                    <textarea name="additional_details" id="additional_details" rows="3"
                                              ...
                                              placeholder="Any additional information about your reservation...">{{ old('additional_details') }}</textarea>
                                </div>
                            </div>
                            </div>
                        </div>
    ...
    <script>
                        ...
                        Swal.fire({
                            ...
                            html: `
                                ...
                                <div class="flex justify-center mt-6">
                                    <button type="button" class="px-6 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors transform hover:scale-105" onclick="window.location.href='{{ route('instructor.reservations') }}'">
                ...
                Swal.fire({
                    ...
                    html: `
                        ...
                        <div class="text-center">
                            ...
                            <p class="text-gray-700 text-lg font-medium">{{ session('error') }}</p>
        ...
        function showReservationConfirmationModal() {
            ...
            fetch('{{ route('instructor.reservations.check-duplicate') }}', {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                    'X-Requested-With': 'XMLHttpRequest',
