        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-3xl font-bold text-gray-900">{{ $completedReservations }}</p>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-3xl font-bold text-gray-900">{{ $thisMonthReservations }}</p>
                                <p class="text-xs text-gray-500 mt-1">{{ date('F Y') }} activity</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <a href="{{ route('instructor.reservations.create') }}" class="group bg-white overflow-hidden shadow-lg sm:rounded-xl border border-gray-100 hover:shadow-xl transition-all duration-300 transform hover:scale-105 hover:border-red-200">
                        <div class="p-6">
                            <div class="flex items-center">
                                <div class="flex-shrink-0">
                    ...
                    <a href="{{ route('instructor.reservations') }}" class="group bg-white overflow-hidden shadow-lg sm:rounded-xl border border-gray-100 hover:shadow-xl transition-all duration-300 transform hover:scale-105 hover:border-blue-200">
                        <div class="p-6">
                            <div class="flex items-center">
                                <div class="flex-shrink-0">
                    ...
                    <a href="{{ route('instructor.incidents.create') }}" class="group bg-white overflow-hidden shadow-lg sm:rounded-xl border border-gray-100 hover:shadow-xl transition-all duration-300 transform hover:scale-105 hover:border-orange-200">
                        <div class="p-6">
                            <div class="flex items-center">
                                <div class="flex-shrink-0">
                    ...
                    <a href="{{ route('instructor.incidents.index') }}" class="group bg-white overflow-hidden shadow-lg sm:rounded-xl border border-gray-100 hover:shadow-xl transition-all duration-300 transform hover:scale-105 hover:border-purple-200">
                        <div class="p-6">
                            <div class="flex items-center">
                                <div class="flex-shrink-0">
                    ...
                    @foreach($recentIncidents as $incident)
                        <div class="border-b border-gray-200 py-4 last:border-b-0">
                            <div class="flex items-center justify-between">
                                <div>
                                    <a href="{{ route('instructor.incidents.show', $incident) }}" class="text-lg font-semibold text-gray-900 hover:text-red-600 transition-colors">
                                        {{ $incident->incident_code }}
                                    </a>
                                    <p class="text-sm text-gray-600 mt-1">
                                        {{ $incident->incident_type }} - {{ $incident->created_at->format('M d, Y') }}
                                    </p>
                                </div>
                                <div class="text-right">
                                    <span class="inline-flex px-3 py-1 text-xs font-semibold rounded-full 
                                        @if($incident->status === 'resolved') bg-green-100 text-green-800 border border-green-200
                                        @elseif($incident->status === 'investigating') bg-yellow-100 text-yellow-800 border border-yellow-200
                ...
                <div class="p-6">
                    @forelse($reservations as $reservation)
                        <div class="border-b border-gray-200 py-4 last:border-b-0">
                            <div class="flex items-center justify-between">
                                <div>
                                    <a href="{{ route('instructor.reservations.show', $reservation) }}" class="text-lg font-semibold text-gray-900 hover:text-red-600 transition-colors">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events: [
                    @foreach($reservations as $reservation)
                    {
                        ...
                        extendedProps: {
                            ...
                            url: '{{ route("instructor.reservations.show", $reservation) }}'
                        }
                    },
                    @endforeach
                ],
                ...
                select: function(info) {
                    ...
                    const url = new URL('{{ route("instructor.reservations.create") }}', window.location.origin);
            ...
            document.getElementById('createReservationBtn').addEventListener('click', function() {
                window.location.href = '{{ route("instructor.reservations.create") }}';
            });
        });
