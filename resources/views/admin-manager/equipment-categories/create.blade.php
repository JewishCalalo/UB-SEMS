    ...
    <div class="py-12 bg-rose-50/40">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('equipment-categories.store') }}" class="space-y-6" id="createCategoryForm" novalidate>
                        @csrf
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea name="description" id="description" rows="4"
                                              class="w-full px-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500 text-base font-medium"
                                              placeholder="Describe what types of equipment belong to this category...">{{ old('description') }}</textarea>
                                    @error('description')
                                        <p class="mt-2 text-sm text-red-600 font-medium">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="flex justify-end space-x-3 pt-4">
                            <x-form-button type="button" variant="secondary" size="md" href="{{ route('equipment-categories.index') }}" icon="fas fa-times">Cancel</x-form-button>
                            <x-form-button type="submit" id="createCategoryBtn" variant="danger" size="md" icon="fas fa-check">Create Category</x-form-button>
                        </div>
                    </form>
                </div>
            </div>
