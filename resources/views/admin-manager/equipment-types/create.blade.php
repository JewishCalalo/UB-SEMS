    ...
    <div class="py-12 bg-rose-50/40">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('equipment-types.store') }}" class="space-y-6" id="createTypeForm" novalidate>
                        @csrf
                        ...
                        <div class="bg-blue-50/60 p-6 rounded-xl border border-blue-100">
                            ...
                            <div class="mt-6">
                                ...
                                <textarea name="description" id="description" rows="4"
                                          class="w-full px-4 py-3 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-base font-medium"
                                          placeholder="Describe what this equipment type is used for...">{{ old('description') }}</textarea>
                                @error('description')
                                    <p class="mt-2 text-sm text-red-600 font-medium">
                                        <i class="fas fa-exclamation-circle mr-1"></i>
                                        {{ $message }}
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 pt-6 border-t border-gray-200">
                            ...
                            <div class="flex flex-col sm:flex-row gap-3">
                                ...
                                <x-form-button type="submit" id="createTypeBtn" variant="primary" icon="fas fa-plus">Create Equipment Type</x-form-button>
                            </div>
                        </div>
                    </form>
                </div>
