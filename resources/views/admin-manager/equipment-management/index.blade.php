             ...
             <div class="bg-gradient-to-r from-red-50 to-orange-50 border-l-4 border-red-500 p-6 rounded-lg shadow-sm mb-6">
                 <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                     ...
                     <div class="flex flex-col sm:flex-row gap-3">
                         <a href="{{ route('equipment-management.wishlisted') }}" 
                         ...
                         <x-form-button variant="primary" size="md" href="{{ route('equipment-management.create') }}" icon="fas fa-plus">
                             Add Equipment
                         </x-form-button>
                     </div>
                 </div>
                     ...
                     <div id="searchFilterContent" class="bg-white border border-gray-200 rounded-lg shadow-sm mb-6" style="display: none;">
                         <div class="p-6">
                            <form id="eqFilterForm" method="GET" action="{{ route('equipment-management.index') }}" class="space-y-6">
                 ...
                 <div class="p-6">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="space-y-1">
                                                    ...
                                                    @if($item && is_object($item) && isset($item->equipmentType) && is_object($item->equipmentType))
                                                        <br>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm text-gray-900">
                                                    ...
                                                    <div class="flex items-center space-x-2">
                                                        <span class="font-bold text-gray-900">{{ $quantityAvailable }}</span>
                                                        <span class="text-gray-600">/</span>
                                                        <span class="font-semibold text-gray-900">{{ $quantityTotal }}</span>
                                                        @if($quantityTotal > 0)
                                                            <span class="text-xs font-medium text-gray-600">({{ $quantityTotal }} instances)</span>
                                                        @endif
                                                    </div>
                                            ...
                                            <td class="px-8 py-4 whitespace-nowrap text-sm font-medium">
                                                ...
                                                @if($itemId > 0)
                                                    <div class="flex items-center space-x-2">
                                                        <a href="{{ route('equipment-management.show', $item) }}" 
                                                        ...
                                                        <a href="{{ route('equipment-management.edit', $item) }}" 
                                                        ...
                                                        <button type="button" 
                                                                id="add_instance_btn_{{ $itemId }}"
                                                                onclick="showAddInstanceModal({{ $itemId }})"
                    ...
                    @else
                        <div class="text-center py-8">
                            ...
                            <div class="mt-6">
                                <a href="{{ route('equipment-management.create') }}" 
        ...
        function openReportModal() {
            Swal.fire({
                ...
                html: `
                    ...
                    <form id="eqReportForm" method="GET" action="{{ route('equipment-management.generate-pdf') }}" class="space-y-4">
                        <div>
                    ...
                    <div class="flex justify-between mt-6">
                        ...
                        <button type="button" class="px-6 py-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg hover:from-purple-700 hover:to-pink-700 transition-all transform hover:scale-105" onclick="(function(){ const f=document.getElementById('eqReportForm'); const params=new URLSearchParams(new FormData(f)).toString(); const fmt=new FormData(f).get('format'); const base = fmt==='excel' ? '{{ route('equipment-management.export-excel') }}' : (fmt==='csv' ? '{{ route('equipment-management.export-csv') }}' : '{{ route('equipment-management.generate-pdf') }}'); window.open(base + (params ? ('?' + params) : ''), '_blank'); })()">Generate Report</button>
                    </div>
                `,
