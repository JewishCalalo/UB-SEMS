...
<head>
    ...
    <meta name="welcome-search-url" content="{{ route('welcome.search') }}">
...
<body class="public-page">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
        ...
        <!-- Search and Filters -->
        {{-- <x-search-and-filter :categories = "$categories" :equipmentTypes = "$equipmentTypes"/> --}}
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="equipment_type" id="equipmentTypeSelect" class="w-full px-3 sm:px-4 py-2 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 bg-white text-sm font-medium transition-all">
                                ...
                                @foreach($equipmentTypes as $type)
                                    <option value="{{ $type->id }}" data-category-id="{{ $type->category_id }}" {{ request('equipment_type') == $type->id ? 'selected' : '' }}>
                                        {{ $type->name }}
                                    </option>
                                @endforeach
                            </select>
        ...
        <div id="equipmentContainer">
            @include('components.equipment-grid', ['equipment' => $equipment])
        </div>
