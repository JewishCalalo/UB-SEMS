        ...
        <div class="content">
            ...
            <ul>
                @foreach($reservation->items as $item)
                    ...
                    @endphp
                    <li>
                        <strong>{{ $brandModel ?: ($item->equipment->name ?? 'Equipment') }}</strong>
            ...
            <p><strong>Important:</strong> Please save your reservation code <strong>{{ $reservation->reservation_code }}</strong> for future reference and tracking.</p>
