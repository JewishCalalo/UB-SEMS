...
<body>
    <div class="wrap">
        ...
        <div class="footer">
            &copy; {{ date('Y') }} University of Baguio • SEMS. Please do not reply to this email.
        </div>
    </div>
</body>
</html>
