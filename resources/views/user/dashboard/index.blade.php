                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-gray-900">{{ $userReservations->count() }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-semibold text-gray-900">{{ $completedReservations }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    <div class="flex justify-between items-center mb-4">
                        <h3 class="text-lg font-semibold text-gray-900">Recent Reservations</h3>
                                                    <a href="{{ route('reservations.index') }}" class="text-blue-600 hover:text-blue-800 text-sm">
                            View All
                        </a>
                    </div>
                                    ...
                                    <div class="flex justify-between items-start">
                                        <div class="flex-1">
                                            <div class="flex items-center space-x-2 mb-2">
                                                ...
                                                <span class="text-xs text-gray-500">{{ $reservation->created_at->format('M d, Y') }}</span>
                                            </div>
                                            ...
                                            @if($reservation->reason)
                                                <p class="text-sm text-gray-600 mt-2">
                                                    <span class="font-medium">Reason:</span> {{ $reservation->reason }}
                                                </p>
                                            @endif
                                        </div>
